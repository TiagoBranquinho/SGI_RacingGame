...
class MyVehicleHandler {
    constructor(app, vehicle) {
        ...
        this.acceleration = 0.0003;  // Adjust the acceleration factor
        this.deceleration = 0.0001;  // Adjust the deceleration factor
        this.braking = 0.0003;  // Adjust the braking factor
    ...
    update() {
        ...
        this.app.activeCamera.lookAt(this.vehicle.model.position); */
    }
